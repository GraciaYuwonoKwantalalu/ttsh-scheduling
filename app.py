...
def home(): 
    ...
    constraints_name = {"doctor_call_daily":"No. of doctors on call daily", "day_off_monthly":"Min no. of days off in 4 weeks", "max_call_month_4":"Max no. of calls in 4-week month", "max_call_month_5":"Max no. of calls in 5-week month",
                        "total_call":"No. of calls and call requests", "clinic_1":"No. of doctors on duty in clinic 1", "clinic_2":"No. of doctors on duty in clinic 2", "amSat_clinic_4":"No. of doctors on duty in amSat clinic 4", 
                        "amSat_clinic_1":"No. of doctors on duty in amSat clinic 1", "amSat_clinic_3":"No. of doctors on duty in amSat clinic 3", "P":"No. of doctors on duty in P"}
...
def download_timetable():
    ...
    color_range = "A1:A{}".format(number_rows+1)
    ...
    worksheet.conditional_format('A2:XFD31', {'type':     'text',
                                            'criteria': 'containing',
                                            'value':    'Duty',
                                            'format':   format1})
    ...
    # Define our range for the color formatting
    color_range = "A1:A{}".format(number_rows2+1)
    ...
    worksheet2.conditional_format('A2:XFD31', {'type':     'text',
                                            'criteria': 'containing',
                                            'value':    'Duty',
                                            'format':   format1})
...
### convert excel to landscape pdf
        ...
        for date_diff in range(delta.days + 1):
            ...
            for element in constraints_result_S[1:]:
                ...
                for key,value in dict_element.items():
                    if 'Clinic 1' in value:
                        counter_clinic1 += 1
                    elif 'Clinic 2' in value:
                        counter_clinic2 += 1
                    elif 'amSat Clinic 1' in value:
